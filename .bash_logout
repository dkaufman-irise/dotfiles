...
# offloading the contents of bash_history somewhere else.  we sort -u so that
# the history file only contains unique commands and thus isn't full of cruft
# like "ls -al foo" a thousand times.
